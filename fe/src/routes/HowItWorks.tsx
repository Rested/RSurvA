...
const HowItWorks = () => {
    ...
    return (
        <div class="p-6 mt-8 max-w-4xl mx-auto bg-base-200 shadow-lg rounded-lg">
            ...
            <div class="mt-6">
                <ul class="list-inside list-disc text-base-content mt-4 space-y-4">
                    <li class="flex items-start">
                        ...
                        <span>
                            <strong>Client-Side Encryption:</strong> Answers are encrypted with a public key on the client side before transmission, meaning they are stored encrypted on the server, keeping answers private.
                        </span>
                    </li>
                    <li class="flex items-start">
            ...
            <Divider text="Sequence Diagram" />
            <div class="mermaid mx-auto max-w-xl bg-white p-6 rounded-lg shadow-md" id="sequence-diagram">
                {diagram}
            </div>
            <Divider text="Limitations & Mitigations" />
            <div class="mb-6" id="limits-and-mitigations">
                <article class="prose lg:prose-xl text-base-content">
                    <ul class="list-disc pl-5">
                        ...
                        <li class="mb-4">
                            <p>
                            <strong>Limitation: Identifying Respondent Through Answers Across Questions</strong> - The survey owner may attempt to look at answers across questions to uncover the respondent's identity.
                            </p>
                        ...
                        <li class="mb-4">
                            ...
                            <p><strong>Chosen mitigation:</strong> While tlock-js could be viable, it introduces a networked 3rd party dependency that needs to be accessible and not compromised when the respondent encrypts or the
                                ...
                                The difference is it has a slightly stronger condition in that there is a timing element. For example, if the survey is posted to a public channel and it's known that the public channel will only be viewed from 10 am by Alice and from 12 pm by Bob, then an answer decrypted at 11 am is likely from Alice. This can also bypass mitigations around question correlation.
                        ...
                        <li class="mb-4">
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li>If the server which serves the frontend is different from the server which serves the backend (which it is in this case - cloudflare pages vs fly.io fastapi app),
                                    then we could conceive of a link generated by the frontend which consists of a reference to the backend identifier to fetch the survey with and a decryption key for the encrypted questions and survey title.</li>
            ...
            <Divider text="Infrastructure" />
            <div class="mb-6">
                <p class="text-base-content">
                    The frontend code (where encryption happens) is hosted on <a href="https://pages.cloudflare.com/" class="text-primary hover:underline">Cloudflare Pages</a>.
                </p>
                <p class="text-base-content">
                    The backend is hosted on <a href="https://fly.io/" class="text-primary hover:underline">Fly.io</a>. The encrypted answer data and unencrypted question data are stored on <a href="https://fly.io/docs/reference/redis/" class="text-primary hover:underline">Fly Upstash for Redis</a>.
                </p>
                <p class="text-base-content">
