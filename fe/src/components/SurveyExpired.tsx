...
const SurveyExpired = ({ surveyQuestions, handleUnlockSurvey, setPrivateKey, privateKey }) => {
    return (
        <div class="p-4 rounded-lg shadow-md mb-4">
            <p class="text-base-content mb-2">This survey has finished!</p>
            {surveyQuestions?.encrypted_answers_sets ? (
                <Fragment>
                    <p class="text-base-content mb-2">If you are the survey owner, you may unlock it with your private key.</p>
                    <input
                        type="text"
